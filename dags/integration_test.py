...
with DAG(
    ...
    def standard_tasks_group():
        ...
        classic_py = PythonOperator(
            task_id="classic_python", python_callable=python_call
        )
    ...
    def long_running(**context):
        ...
        print(
            f"This task runs for {minutes_to_run} minute{'s' if minutes_to_run > 1 else ''}."
        )
